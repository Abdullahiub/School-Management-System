...
import { Student, Exam, StudentResult, SchoolClass } from '../types.js';
import {
  Notebook,
  CalendarCheck,
  Search,
  ...
  return (
    <div id="teacher-dashboard-root" className="space-y-8 animate-fade-in text-xs">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        {/* 1. Student Roster */}
        <div className="lg:col-span-5 bg-white dark:bg-slate-900 border border-gray-150 dark:border-slate-800 rounded-3xl p-5 space-y-4 shadow-sm flex flex-col justify-between">
        ...
        {/* 2. Mark Attendance Panel */}
        <div className="lg:col-span-7 bg-white dark:bg-slate-900 border border-gray-150 dark:border-slate-800 rounded-3xl p-5 space-y-4 shadow-sm">
          ...
          <div className="space-y-2.5 max-h-72 overflow-y-auto pr-1">
            {attendanceStudents.map((as, index) => (
              <div key={as.id} className="p-3 bg-slate-50 dark:bg-slate-850 rounded-2xl flex items-center justify-between">
            ...
            <div className="bg-slate-50 dark:bg-slate-850 p-4 border rounded-3xl text-slate-700 dark:text-slate-300 max-h-72 overflow-y-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {students.filter(s => s.classId === myClass.id).map(s => {
                  ...
                  const percent = currentScore; // assuming max marks = 100
